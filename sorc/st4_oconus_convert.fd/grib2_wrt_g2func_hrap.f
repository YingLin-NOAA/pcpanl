      subroutine grib2_wrt_g2func_hrap(nx,ny,alat,alon,     
...
!
      ...
      real, parameter :: dx= 4.7625, dy= 4.7625, alonv=255., alatdxdy=60.
! 
...
!
      write(6,*) 'in grib2_wrt_g2func_hrap, alat, alon=', 
     &    alat, alon
!
! code start
!-----------------------------------------------------------------
...
!-- set up grid definition template 3.0
        ...
        igdstmpl(8) = nx
        igdstmpl(9) = ny
        igdstmpl(10) = alat*1000000
        igdstmpl(11) = alon*1000000
        igdstmpl(12) = res_comp_flag 
        igdstmpl(13) = alatdxdy*1000000
        igdstmpl(14) = alonv*1000000
...
!(0: at a point in time; 8 for average or accumulation) 
      ipdstmpllen=29          ! pdt template length, per http://www2.nco.ncep.noaa.gov/sib/grib2/examples/nesdis/HEtoGrib2.f90
                       
      ipdstmpl(1)=iptable(4)  ! catogory
      ipdstmpl(2)=iptable(5)  ! parameter
      ipdstmpl(3)=0           ! Type of generating process (Table 4.3) (0:ana, 1:ic, 2:fcst)
